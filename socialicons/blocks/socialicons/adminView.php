...
<div id="design-menu">
    ...
    <div id="previewmenu" class="features">
		...
		foreach ($menu AS $id => $item) {
			...
			<div class="inline-block" style="width: 12%;box-sizing: border-box;"><img src="<?php echo BASE_PATH . 'modules/socialicons/lib/' . $item['icon'] ?>.svg"><input type="hidden" name="menu[<?php echo $id ?>][icon]"  value="<?php echo $item['icon'] ?>" /></div>
...
<script>
    $(document).ready(function() {
        ...
        <?php
            $imgs = '';
            foreach (glob("modules/socialicons/lib/*.svg") as $filename) {
